...
Given a wallet address and a mint address, you always know the ATA. No storage is needed.
...
**Recent Blockhash instead of nonce**: Solana transactions do not use a sequential nonce.
...
No manual web interaction is needed. This simplifies automated test setup.
