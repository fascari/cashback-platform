...
func (_m *Repository) FindByID(ctx context.Context, id int64) (domain.Purchase, error) {
...
func (_c *Repository_FindByID_Call) Return(_a0 domain.Purchase, _a1 error) *Repository_FindByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_FindByID_Call) RunAndReturn(run func(context.Context, int64) (domain.Purchase, error)) *Repository_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
